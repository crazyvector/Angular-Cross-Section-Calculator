...
int main(int argc, char* argv[]) {
    ...
    //cerr << "To recompile the file : g++ datagrepdeadtime.cpp -o datagrepdeadtime" << endl;
    ...
    while (std::getline(input, line)) {
        ...
        // Find the dead time correction factor
        searchStr = "=> DEAD TIME CORRECTION FACTOR =";
        pos = line.find(searchStr);
